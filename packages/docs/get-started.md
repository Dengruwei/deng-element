...
// 引入样式
import "d-element/dist/style.css";

import App from "./App.vue";
// 全局使用
createApp(App).use(DElement).mount("#app");
```
...
d-element 提供了基于 ES Module 的开箱即用的 Tree Shaking 功能。
...
<script>
import { ErButton } from "d-element";
export default {
  components: { ErButton },
};
</script>
